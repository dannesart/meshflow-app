  ...
  <NuxtLayout :name="layout">
    ...
    <template #left>
      <div class="flex gap-4 scale-90">
        <img
          src="~~/assets/images/city-wallpaper.png"
          class="bg-white rounded-xl h-full"
        />
      </div>
    </template>
    <template #right>
      <div
        class="w-full flex flex-col gap-6 px-6 self-center justify-self-center place-self-center justify-center"
      >
        ...
        <footer class="flex flex-col md:flex-row gap-4">
