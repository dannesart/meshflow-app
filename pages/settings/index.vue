    ...
    <section class="flex flex-col gap-6 p-6 bg-white shadow-lg rounded-xl">
      <div class="flex flex-col gap-3">
        ...
        <ModulesTagsList color="white" can-add="true" @add="addNewTag">
          <draggable
            :list="taskStatuses"
            item-key="id"
            :component-data="{ class: 'flex gap-3' }"
          >
      ...
      <div class="flex flex-col gap-3">
        ...
        <ModulesInput
          type="checkbox"
          name="allow-sprints"
          :value="settingsStore.isUsingSprints"
    ...
    <section class="flex flex-col gap-6 p-6 bg-white shadow-lg rounded-xl">
      <div class="flex flex-col gap-3">
        ...
        <p class="text-sm text-gray-400">
          Leaving this project means that the project will stay alive. <br />You
          can't leave if you are the creator of this project. <br />But you can
          transfer the ownership to any other user.
        </p>
        <div>
      ...
      <div class="flex flex-col gap-3">
        ...
        <p class="text-sm text-gray-400">
          ...
          <br />Users, data, blocks, pages, settings, rules, roles and storage.
        </p>
        <div>
