<template>
  <UIForm :class="'flex flex-col gap-4'" name="new-page-form">
    <ModulesInput
      @valueUpdate="valueChange($event, 'title')"
      :name="'title'"
      type="text"
      :value="newPage?.title"
    >
    ...
    <div class="p-3 px-4 rounded-lg bg-gray-100">
      This will not be public once it's created
    </div>
  </UIForm>
</template>
...
import { PageSchema, PAGE_STATUSES } from "~~/models/page";
