<template>
    <UIForm :class="'flex flex-col gap-6'" name="new-model-form">
        ...
        <ModulesInput type="text" :max="50" :value="newModelForm.name" @valueUpdate="$event => valueChange($event, 'name')">
            Name
        </ModulesInput>

        <ModulesInput type="text-lg" :max="100" :value="newModelForm.description"
        ...
        <div name="new-model-error" class="flex gap-4 bg-red-50 p-4 rounded-lg mt-6" v-for="error in errors">
