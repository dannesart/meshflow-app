<template>
  ...
  <svg
    v-if="name.toLowerCase() === 'richtext'"
    :class="getSize(size || 6)"
    xmlns="http://www.w3.org/2000/svg"
    stroke-width="1.5"
    viewBox="0 0 24 24"
  ...
  <svg
    v-if="name.toLowerCase() === 'media' || name.toLowerCase() === 'image'"
    fill="currentColor"
    xmlns="http://www.w3.org/2000/svg"
    :class="getSize(size || 6)"
    viewBox="0 0 24 24"
