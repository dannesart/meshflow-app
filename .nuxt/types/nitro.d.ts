...
declare module 'nitropack' {
  ...
  interface InternalApi {
    '/api/user': Awaited<ReturnType<typeof import('../../server/api/user').default>>
    '/api/tasks': Awaited<ReturnType<typeof import('../../server/api/tasks').default>>
    '/api/settings': Awaited<ReturnType<typeof import('../../server/api/settings').default>>
    '/api/projects': Awaited<ReturnType<typeof import('../../server/api/projects').default>>
